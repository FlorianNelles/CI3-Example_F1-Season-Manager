				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel"><?php echo $this->lang->line('delete_title') ?><?php echo $team['name'];?></h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
							<?php echo $this->lang->line('delete_message_1') ?> <?php echo $team['name'];?> <?php echo $this->lang->line('delete_message_2') ?>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo $this->lang->line('cancel') ?></button>
							<a class="btn btn-danger" href="<?php echo site_url('teams/delete/'.$team['id']);?>"><?php echo $this->lang->line('delete') ?></a>
						</div>
					</div>
				</div>
			</div>
